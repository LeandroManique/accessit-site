      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-white/85 leading-relaxed max-w-lg">
              Transformamos sua TI em vantagem competitiva e estratégica para
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#ff7a33] text-white font-bold text-base hover:bg-[#c74600] transition-colors duration-200 shadow-lg"
              >
              ...
              <Link
                href="/solucoes"
                className="inline-flex items-center justify-center px-7 py-3.5 rounded-full border-2 border-white/60 text-white font-semibold text-base hover:border-white hover:bg-white/10 transition-colors duration-200"
              >
                Ver Soluções
              </Link>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/20">
          <p className="text-white/70 text-sm">
            <span className="font-semibold text-white">Bem-vindo à AccessIT | Brasil</span>
            {" "}— Soluções em Tecnologia e Equipamentos de TI para empresas.
          </p>
        </div>
      </div>
    </section>
